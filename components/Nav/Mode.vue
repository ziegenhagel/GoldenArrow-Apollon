...
const mode = computed(() => router.currentRoute.value.path === '/Verwaltungsmodus' ? 'Verwaltungsmodus' : router.currentRoute.value.path === '/Explorationsmodus' ? 'Explorationsmodus' : 'Unbekannter Modus')
